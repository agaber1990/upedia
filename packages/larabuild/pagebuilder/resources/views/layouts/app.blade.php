...
<head>
    ...
    {{-- Icon Picker --}}
    <link rel="stylesheet" href="{{ asset('/vendor/optionbuilder/css/iconPicker.css')}}">
    ...
    <link rel="stylesheet" href="{{asset('/theme/'.activeTheme().'/css/pagebuilder_custom.css')}}"> 
</head>
...
<body>
    ...
    {{-- Icon Picker --}}
    <script defer src="{{ asset('/vendor/optionbuilder/js/iconPicker.js') }}"></script>
    <script>
