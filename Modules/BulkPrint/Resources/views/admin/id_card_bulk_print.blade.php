                    ...
                    <div class="horizontal__card"
                        ...
                        <div class="horizontal_card_header"
                            ...
                            <div class="logo__img logoImage hLogo"
                                style="line-height:1.02; width: 80px; background-image: url({{ $id_card->logo != '' ? asset($id_card->logo) : asset('/backEnd/img/logo.png') }});height: 30px; background-size: cover; background-repeat: no-repeat; background-position: center center;">
                            </div>
                        </div>
                            ...
                            <div class="thumb hRoundImg hSize photo hImg hRoundImg"
                                style="
                                                        ...
                                                        background-image: url(
                                                            @if ($role_id == 2) {{ @$staff_student->student_photo != '' ? asset(@$staff_student->student_photo) : (@$id_card->profile_image != '' ? asset(@$id_card->profile_image) : asset('/backEnd/id_card/img/thumb.png')) }}
                                                            @else
                                                                {{ @$staff_student->staff_photo != '' ? asset(@$staff_student->staff_photo) : (@$id_card->profile_image != '' ? asset(@$id_card->profile_image) : asset('/backEnd/id_card/img/thumb.png')) }} @endif
                    ...
                    <div class="vertical__card"
                        ...
                        <div class="horizontal_card_header"
                            ...
                            <div class="logo__img logoImage vLogo"
                                style="line-height:1.02; width: 80px; background-image: url({{ $id_card->logo != '' ? asset($id_card->logo) : asset('/backEnd/img/logo.png') }});background-size: cover; height: 30px;background-position: center center; background-repeat: no-repeat;">
                            </div>
                        </div>
            ...
            @else
                ...
                <div id="gHorizontal"
                    ...
                    <div class="horizontal__card"
                        ...
                        <div class="horizontal_card_footer" style="line-height:1.02; text-align: right;">
                            <div class="singnature_img signPhoto hSign"
                                style="background-image:url('{{ asset('/backEnd/id_card/img/Signature.png') }}');line-height:1.02; width: 50px; flex: 50px 0 0; margin-left: auto; position: absolute; right: 10px; bottom: 7px;height: 25px; background-size: cover; background-repeat: no-repeat; background-position: center center;">
                            </div>
                        </div>
                    </div>
                </div>
                                ...
                                <div class="child__thumbs"
                                    ...
                                    <div class="single__child" style="text-align: center; flex: 75px 0 0; ">
                                        <div class="single__child__thumb"
                                            style=" background-image: url({{ @$studentInfo->student_photo != '' ? asset(@$studentInfo->student_photo) : asset('/backEnd/id_card/img/thumb.png') }});background-size: cover; background-position: center center; background-repeat: no-repeat; line-height:1.02; width: 45px;
                                                                        flex: 45px 0 0;
                                                                        height: 46px; margin: auto;border-radius: 50%; padding: 3px; align-content: center; justify-content: center; display: flex; border: 3px solid #fff;">
                                        </div>
