    ...
    public function run()
    {
        ...
        if($allData['Saas'] == TRUE){
            ...
            for($i=2; $i<=5; $i++){
                ...
                $staff->school_id       = $i;
                $staff->email           = $email;
                $staff->staff_photo     = '/uploads/staff/1_infix_edu.jpg';
                ...
                DB::table('sm_testimonials')->insert([
                    [
                        ...
                        'image' => '/uploads/testimonial/testimonial_1.jpg',
                    ...
                    [
                        ...
                        'image' => '/uploads/testimonial/testimonial_2.jpg',
                        'description' => 'its vast! Infix has more additional feature that will expect in a complete solution.',
                        'created_at' => date('Y-m-d h:i:s')
                    ],
                ]);
                ...
                for ($t = 1; $t <= 5; $t++) {
                    DB::table('sm_courses')->insert([
                        'title' => $faker->text(50),
                        'image' => '/uploads/course/academic' . $t++ . '.jpg',
                ...
                for ($role_id = 4; $role_id <10; $role_id++) {
                    ...
                    $newUser->email     = $First_Name . $j . '@upedia.com';
                    $newUser->username  = $First_Name . $j . '@upedia.com';
                ...
                for ($j = 1; $j <= 20; $j++) {
                                ...
                                $studentEmail = strtolower($student_User_Name) . $j . '@upedia.com';
                                ...
                                $newUser->email     = strtolower($Father_User_Name).'_pa' . $j . '@upedia.com';
                                $newUser->username  = strtolower($Father_User_Name).'_pa' . $j . '@upedia.com';
                                $newUser->password  = Hash::make(123456);
                                ...
                                $parent->guardians_email      = $Guardian_First_Name . $j . '@upedia.com';
