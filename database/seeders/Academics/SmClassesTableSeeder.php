...
class SmClassesTableSeeder extends Seeder
{
    ...
    /**
     * Get the last 5 days for attendance records.
     *
     * @return array
     */
    private function lastOneMonthDates()
    {
        $dates = [];
        for ($i = 0; $i < 5; $i++) {
        ...
        try {
            ...
            SmClass::factory()->times($count)->create([
                ...
                foreach ($sections as $section) {
                    ...
                    SmStudent::factory()->times(2)->create()->each(function ($student) use ($class, $section, $school_id) {
                        ...
                        SmParent::factory()->times(1)->create([
                            'school_id' => $school_id,
                            'guardians_email' => 'guardian_' . $student->id . '@upedia.com',
                        ...
                        foreach ($this->lastOneMonthDates() as $date) {
                ...
                SmAdmissionQuery::factory()->times(2)->create([
                    'class' => $class->id,
                    'school_id' => $school_id,
                    'academic_id' => $class->academic_id,
                ])->each(function ($admission_query) use ($school_id) {
                    SmAdmissionQueryFollowup::factory()->times(random_int(1, 3))->create([
