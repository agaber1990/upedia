...
class CreateInfixModuleManagersTable extends Migration
{
    ...
    public function up()
    {
        ...
        try {
            ...
            $s->update_url = "https://spondonit.com/contact";
            $s->is_default = 0;
            $s->addon_url = "https://codecanyon.net/item/razorpay-payment-gateway-for-upedia/27721206?s_rank=11";
            $s->installed_domain = url('/');
            $s->activated_date = date('Y-m-d');
            $s->save();
            ...
            $bulk_print->addon_url = "https://codecanyon.net/item/upedia-zoom-live-class/27623128?s_rank=12";
            ...
            $s->save();
             ...
             $s->update_url = "https://spondonit.com/contact";
             $s->is_default = 0;
             $s->addon_url = "https://codecanyon.net/item/google-meet-module-for-upedia-gmeet-live-class/42463761";
             $s->installed_domain = url('/');
             $s->activated_date = date('Y-m-d');
             $s->save();
            ...
            $s->name = "CcAveune";
            $s->email = 'support@spondonit.com';
            $s->notes = "This CcAveune Module For upedia . Manage online payment for fees & wallet.";
            $s->version = "1.0";
            $s->update_url = "https://spondonit.com/contact";
            $s->is_default = 0;
        ...
        // Certificate
            ...
            $s->email = 'support@spondonit.com';
            $s->notes = "This InAppLiveClass Module For upedia . Manage Online Class and Meeting Reports.";
            $s->version = "1.0";
            $s->update_url = "https://spondonit.com/contact";
            $s->is_default = 0;
            $s->addon_url = "maito:support@spondonit.com";
