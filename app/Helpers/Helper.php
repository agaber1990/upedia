...
if (!function_exists('defaultUserLogo')) {
    function defaultUserLogo($path)
    {
        if ($path && file_exists($path)) {
            ...
            return asset('/uploads/staff/demo/staff.jpg');
        }
    }
}
...
if (!function_exists('getProfileImage')) {
    function getProfileImage($user_id)
    {
        ...
        if ($role_id == 2) {
            $profile = $student->student_photo ? $student->student_photo : '/backEnd/assets/img/avatar.png';
        } elseif ($role_id == 3) {
            $profile = $parent->fathers_photo ? $parent->fathers_photo : 'c';
        } else {
            $profile = $staff->staff_photo ? $staff->staff_photo : '/backEnd/assets/img/avatar.png';
        }
        return $profile;
    }
