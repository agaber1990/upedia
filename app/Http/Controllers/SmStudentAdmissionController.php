...
class SmStudentAdmissionController extends Controller
{
    ...
    function studentUpdatePic(Request $r, $id)
    {
        ...
        try {
            ...
            if ($r->hasFile('logo_pic')) {
                ...
                $pathImage = '/uploads/student/';
                if (!file_exists($pathImage)) {
                    mkdir($pathImage, 0777, true);
                    $name = md5($file->getClientOriginalName() . time()) . "." . "png";
                    $images->save('/uploads/student/' . $name);
                    $imageName = '/uploads/student/' . $name;
    ...
    public function studentStore(Request $request)
    {
        ...
        if ($request->file('document_file_1') != "") {
            ...
            $file->move('/uploads/student/document/', $document_file_1);
            $document_file_1 =  '/uploads/student/document/' . $document_file_1;
        }
        ...
        if ($request->file('document_file_2') != "") {
            ...
            $file->move('/uploads/student/document/', $document_file_2);
            $document_file_2 =  '/uploads/student/document/' . $document_file_2;
        }
        ...
        if ($request->file('document_file_3') != "") {
            ...
            $file->move('/uploads/student/document/', $document_file_3);
            $document_file_3 =  '/uploads/student/document/' . $document_file_3;
        }
        ...
        if ($request->file('document_file_4') != "") {
            ...
            $file->move('/uploads/student/document/', $document_file_4);
            $document_file_4 =  '/uploads/student/document/' . $document_file_4;
        }
                            ...
                            foreach ($dataImage as $label => $field) {
                                if (is_object($field)) {
                                    ...
                                    if ($field != "") {
                                        ...
                                        $file->move('/uploads/customFields/', $key);
                                        $dataImage[$label] =  '/uploads/customFields/' . $key;
                                    }
                                }
                            }
        ...
        try { 
            if ($request->file('photo') != "" && $request->title != "") {
                ...
                if ($request->file('photo') != "") {
                    ...
                    $file->move('/uploads/student/document/', $document_photo);
                    $document_photo =  '/uploads/student/document/' . $document_photo;
                }
        ...
        try {
            if ($request->title != "") {
                ...
                if ($request->file('document_file_4') != "") {
                    ...
                    $file = $request->file('document_file_4');
                    $document_photo = 'stu-' . md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
                    $file->move('/uploads/student/timeline/', $document_photo);
                    $document_photo =  '/uploads/student/timeline/' . $document_photo;
                }
