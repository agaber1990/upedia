...
class ThemeController extends Controller
{
    ...
    public function store(ThemeFormRequest $request)
    {
        ...
        try {
            ...
            $theme->background_image = fileUpload($request->background_image, '/backEnd/img/');
    ...
    public function update(ThemeFormRequest $request, Theme $theme)
    {
        ...
        try {
            ...
            $theme->background_image = fileUpdate($theme->background_image, $request->background_image, '/backEnd/img/');
            $theme->background_color = $request->background_color;
            $theme->save();
