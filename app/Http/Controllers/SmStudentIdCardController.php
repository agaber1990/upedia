    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('logo') != "") {
                ...
                $file->move('/uploads/studentIdCard/', $fileNameLogo);
                $fileNameLogo = '/uploads/studentIdCard/' . $fileNameLogo;
            }
            ...
            if ($request->file('signature') != "") {
                ...
                $file->move('/uploads/studentIdCard/', $fileNameSignature);
                $fileNameSignature = '/uploads/studentIdCard/' . $fileNameSignature;
            }
            ...
            if ($request->file('background_img') != "") {
                ...
                $file->move('/uploads/studentIdCard/', $fileNameBackground);
                $fileNameBackground = '/uploads/studentIdCard/' . $fileNameBackground;
            }
            ...
            if ($request->file('profile_image') != "") {
                ...
                $file->move('/uploads/studentIdCard/', $fileNameProfileImage);
                $fileNameProfileImage = '/uploads/studentIdCard/' . $fileNameProfileImage;
            }
