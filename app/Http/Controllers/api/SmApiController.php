    ...
    public function UpdateStaffApi(Request $request)
    {
        ...
        if (!empty($request->field_name)) {
            ...
            if ($request_string == "email") {
                ...
                $images->save('/uploads/staff/' . $staff_photos);
                $staff_photo = '/uploads/staff/' . $staff_photos;
    ...
    public function UpdateStudentApi(Request $request)
    {
        ...
        if (!empty($request->field_name)) {
            ...
            if ($request_string == "first_name") {
                ...
                $images->save('/uploads/student/' . $student_photos);
                $student_photo = '/uploads/student/' . $student_photos;
    ...
    public function postal_receive_store(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('file') != "") {
                $file = $request->file('file');
                $fileName = md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
                $file->move('/uploads/postal/', $fileName);
                $fileName = '/uploads/postal/' . $fileName;
            }
    ...
    public function saveUploadContent(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('content_file') != "") {
                $file = $request->file('content_file');
                $fileName = md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
                $file->move('/uploads/upload_contents/', $fileName);
                $fileName = '/uploads/upload_contents/' . $fileName;
            }
    ...
    public function income_store(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('file') != "") {
                $file = $request->file('file');
                $fileName = md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
                $file->move('/uploads/add_income/', $fileName);
                $fileName = '/uploads/add_income/' . $fileName;
            }
    ...
    public function Approve_Leave_store(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('attach_file') != "") {
                ...
                $fileName = md5($file->getClientOriginalName() . time()) . "." . $file->getClientOriginalExtension();
                $file->move('/uploads/leave_request/', $fileName);
                $fileName = '/uploads/leave_request/' . $fileName;
            }
    ...
    public function updateSchoolLogo(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('main_school_logo') != "") {
                ...
                $file->move('/uploads/settings/', $main_school_logo);
                $main_school_logo = '/uploads/settings/' . $main_school_logo;
                ...
                $file->move('/uploads/settings/', $main_school_favicon);
                $main_school_favicon = '/uploads/settings/' . $main_school_favicon;
                $generalSettData = SmGeneralSettings::find(1);
    ...
    public function childBankSlipStore(Request $request)
    {
        ...
        try {
            ...
            if ($request->file('slip') != "") {
                ...
                $fileName = '/uploads/bankSlip/' . $fileName;
            }
