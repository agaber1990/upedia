                            ...
                            <td style="padding: 0">
                                <div class="logo_img">
                                    ...
                                    <div class="profile_thumb">
                                        <img src="{{ file_exists(@$student_detail->student_photo) ? asset($student_detail->student_photo) : asset('/uploads/staff/demo/staff.jpg') }}" alt="{{@$student_detail->full_name}}" height="100" width="100">
                                    </div>
                                </div>
                            </td>
                        </thead>
