                            ...
                            <div class="{{(resultPrintStatus('header'))? "logo_img": "logo_img custom_result_print"}}">
                                ...
                                @if(resultPrintStatus('image'))
                                    <div class="profile_thumb">
                                        <img src="{{ file_exists(@$student_detail->studentDetail->student_photo) ? asset($student_detail->studentDetail->student_photo) : asset('/uploads/staff/demo/staff.jpg') }}" alt="{{$student_detail->studentDetail->full_name}}" height="100" width="100">
                                    </div>
                                @endif
                            </div>
                        </td>
