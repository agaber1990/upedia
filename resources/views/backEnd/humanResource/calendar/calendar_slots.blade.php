        ...
        $(document).ready(function() {
                ...
                `);
                    ...
                    function fetchAvailableTeachers() {
                        ...
                        } else if (schedule === 'twice' && day1 && startTime1 && endTime1 && day2 && startTime2 &&
                            endTime2) {
                            days.push({
                                day: day1,
                                startTime: startTime1,
                                ...
                                success: function(response) {
                                    ...
                                    if (response.teachers && response.teachers.length > 0) {
                                        response.teachers.forEach(function(teacher) {
                                            ...
                                            allTeachers[teacher.id].slots[slot.day] = teacher
                                                .slots || [];
                                        });
                                    } else {
                        ...
                        $.when.apply($, promises).then(function() {
                            ...
                            if (schedule === 'twice') {
                                for (let teacherId in allTeachers) {
                                    ...
                                    let hasAllDays = days.every(function(slot) {
                                        ...
                                        return teacherSlots.length >
                                        0; // The Backend already ensures coverage
                                    });
                            ...
                            let hasNoTeachers = Object.keys(allTeachers).some(key => key.startsWith(
                            'no_teachers_'));
                ...
                `;
                            ...
                            <tr>
                                ...
                                ${allDates.map(item => {
                                    ...
                                    data - slot - id = "${slotItem.slot_id}"
                                    data - date = "${item.date}" > $ {
                                        slotText
                                    } < /div>`;
                            }).join(''): '<div>No slots available</div>';
