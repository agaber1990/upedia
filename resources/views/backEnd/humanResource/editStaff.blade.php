                                                    ...
                                                    <div class="form-section">
                                                        <div class="row mb-20">
                                                                <label class="primary_input_label" for="">@lang('hr.staff_type')
                                                                    ...
                                                                    <select class="primary_select form-control" id="staff_type" name="emp_type_id" >

                                                                            @foreach ($staff_type as $type)
                                                                                <option value="{{ $type->id }}" 
                                                                                    {{ old('staff_type', $editData->emp_type_id) == $type->id ? 'selected' : '' }}>
                                                                ...
                                                                <select
                                                                    ...
                                                                    id="select_types" name="slots_emp_id">
                                                                    @foreach ($slots_emp as $type)
                                                                        <option value="{{ $type->id }}"
                                                                            {{ old('slots_emp', $editData->slots_emp_id) == $type->id ? 'selected' : '' }}>
                                                                          
                                                                            {{ $type->slot_name }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
                                                                <label class="primary_input_label" for="">@lang('hr.specialization')
                                                                    <span class="text-danger"> *</span></label>
                                                                <select
                                                                    class="primary_select form-control {{ $errors->has('specialization') ? ' is-invalid' : '' }}"
                                                                    id="select_types" name="specialization_id">
                                                                    @foreach ($specialization as $type)
                                                                        <option value="{{ $type->id }}"
                                                                            {{ old('specialization', $editData->specialization_id) == $type->id ? 'selected' : '' }}>
                                                                            {{ $type->title }}
                                                                        </option>
                                                                    @endforeach
                                                                </select>
