...
<head>
    ...
    <title>{{ $setting->site_title ? $setting->site_title : 'upedia ERP' }}</title>
    ...
    <link rel="stylesheet" href="{{ asset('/frontend/') }}/css/{{ @activeStyle()->path_main_style }}" />


    @if (isset($ttl_rtl) && $ttl_rtl == 1)
        <link rel="stylesheet" href="{{ url('/backEnd/') }}/assets/vendors/vendors_static_style.css" />
    ...
    <link rel="stylesheet" href="{{ asset('/') }}/frontend/css/infix.css" />
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                <div class="container box-1420">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}/home">
                        <img class="w-75"
                            src="{{ asset($setting->logo ? $setting->logo : '/uploads/settings/logo.png') }}"
