...
@pushonce(config('pagebuilder.site_style_var'))
    <link rel="stylesheet" href="{{ asset('/theme/edulia/packages/photoswipe/photoswipe.min.css') }}">
    <link rel="stylesheet" href="{{ asset('/theme/edulia/packages/photoswipe/default-skin.min.css') }}">
@endpushonce
...
@pushonce(config('pagebuilder.site_script_var'))
    <script src="{{ asset('/theme/edulia/packages/photoswipe/photoswipe.min.js') }}"></script>
    <script src="{{ asset('/theme/edulia/packages/photoswipe/photoswipe-ui-default.min.js') }}"></script>
    <script src="{{ asset('/theme/edulia/packages/photoswipe/photoswipe-simplify.min.js') }}"></script>
    <script>
