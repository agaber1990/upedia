...
use App\Http\Controllers\Admin\hr\SpecilizationController;
...
Route::get('/reg', function () {});
    ...
    Route::group(['middleware' => ['CheckDashboardMiddleware']], function () {
        ...
        // emtype Routes
        Route::get('emtype', 'Admin\Hr\EmTypeController@index')->name('emtype');

        Route::post('emtype', 'Admin\Hr\EmTypeController@store')->name('emtype-store')->middleware('userRolePermission:emtype-store');

        Route::get('emtype/{id}', 'Admin\Hr\EmTypeController@show')->name('emtype-edit')->middleware('userRolePermission:emtype-edit');

        Route::put('emtype/{id}', 'Admin\Hr\EmTypeController@update')->name('emtype-update')->middleware('userRolePermission:emtype-edit');

        Route::delete('emtype/{id}', 'Admin\Hr\EmTypeController@destroy')->name('emtype-delete')->middleware('userRolePermission:emtype-delete');

        // slotemployee Routes
        Route::get('slotemployee', 'Admin\Hr\SlotEmpController@index')->name('slotemployee.index');

        Route::post('slotemployee', 'Admin\Hr\SlotEmpController@store')->name('slotemployee-store')->middleware('userRolePermission:slotemployee-store');

        Route::get('slotemployee/{id}', 'Admin\Hr\SlotEmpController@show')->name('slotemployee-edit')->middleware('userRolePermission:slotemployee-edit');

        Route::put('slotemployee/{id}', 'Admin\Hr\SlotEmpController@update')->name('slotemployee-update')->middleware('userRolePermission:slotemployee-edit');

        Route::delete('slotemployee/{id}', 'Admin\Hr\SlotEmpController@destroy')->name('slotemployee-delete')->middleware('userRolePermission:slotemployee-delete');
        ...
        Route::get('specilization/{id}', 'Admin\Hr\SpecilizationController@show')->name('specilization-edit')->middleware('userRolePermission:specilization-edit');

        Route::put('specilization/{id}', 'Admin\Hr\SpecilizationController@update')->name('specilization-update')->middleware('userRolePermission:specilization-edit');

        Route::delete('specilization/{id}', 'Admin\Hr\SpecilizationController@destroy')->name('specilization-delete')->middleware('userRolePermission:specilization-delete');
        ...
        Route::put('track_levels', 'Admin\Academics\TrackLevelController@update')->name('track_level_update');
        ...
        Route::post('tracks-pricing-plan/{id}', 'Admin\Hr\TrackPricingPlanController@store')->name('track-pricing-plan.store')->middleware('userRolePermission:tracksPricingPlan');
        ...
        Route::get('pricing_plan_types/{id}', 'Admin\Academics\PricingPlanTypeController@show')->name('pricing_plan_type_edit')->middleware('userRolePermission:pricing_plan_type_edit');
        Route::put('pricing_plan_types/{id}', 'Admin\Academics\PricingPlanTypeController@update')->name('pricing_plan_type_update')->middleware('userRolePermission:pricing_plan_type_update');
        Route::delete('pricing_plan_types/{id}', 'Admin\Academics\PricingPlanTypeController@destroy')->name('pricing_plan_type_delete')->middleware('userRolePermission:pricing_plan_type_delete');
        // discount_plans Routes

        // categories Routes
        Route::get('categories', 'Admin\Academics\CategoryController@index')->name('categories')->middleware('userRolePermission:categories');
        Route::post('categories', 'Admin\Academics\CategoryController@store')->name('categories-store')->middleware('userRolePermission:categories-store');
        Route::get('categories/{id}', 'Admin\Academics\CategoryController@show')->name('categories-edit')->middleware('userRolePermission:categories-edit');
        Route::put('categories/{id}', 'Admin\Academics\CategoryController@update')->name('categories-update')->middleware('userRolePermission:categories-edit');
        Route::delete('categories/{id}', 'Admin\Academics\CategoryController@destroy')->name('categories-delete')->middleware('userRolePermission:categories-delete');
        // discount_plans Routes
        Route::get('discount_plans', 'Admin\Academics\DiscountPlanController@index')->name('discount_plans')->middleware('userRolePermission:discount_plans');
        Route::post('discount_plans', 'Admin\Academics\DiscountPlanController@store')->name('discount_plans-store')->middleware('userRolePermission:discount_plans-store');
        Route::get('discount_plans/{id}', 'Admin\Academics\DiscountPlanController@show')->name('discount_plans-edit')->middleware('userRolePermission:discount_plans-edit');
        ...
        Route::delete('sm_courses/{id}', 'Admin\Academics\SmCourseController@course_students_delete')->name('course_students_delete');
        ...
        // finance Routes
        Route::get('finance/invoice/create', 'Admin\Finance\FinanceController@create')->name('create_invoice');
